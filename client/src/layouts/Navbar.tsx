...
const Navbar = () => {
  ...
  const formattedTable = tableNumber < 10 ? `0${tableNumber}` : tableNumber.toString();

  return (
    <nav className="h-16 bg-white border-b border-primary/10 flex items-center justify-between px-4 xl:px-24 sticky top-0 z-50 shadow-sm font-display">
